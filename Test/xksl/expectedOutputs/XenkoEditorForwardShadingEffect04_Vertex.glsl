...
layout(location = 4) out vec4 VS_OUT_ScreenPosition;
...
void main()
{
    VS_STREAMS _streams = VS_STREAMS(vec4(0.0), 0.0, vec3(0.0), vec4(0.0), vec3(0.0), vec4(0.0), vec4(0.0), 0.0, vec4(0.0), vec4(0.0), vec2(0.0), 0.0);
