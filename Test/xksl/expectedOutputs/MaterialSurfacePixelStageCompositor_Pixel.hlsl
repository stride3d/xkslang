...
{
    return DynamicTexture_Texture.Sample(DynamicSampler_Sampler, (_streams.TexCoord_id39 * ComputeColorTextureScaledOffsetDynamicSampler_scale) + ComputeColorTextureScaledOffsetDynamicSampler_offset);
}
...
{
    _streams.lightColor_id29 = o0S297C0_LightDirectionalGroup_8__Lights[lightIndex].Color;
    _streams.lightDirectionWS_id28 = -o0S297C0_LightDirectionalGroup_8__Lights[lightIndex].DirectionWS;
}
