...
cbuffer PerMaterial
{
    ...
    float4 ComputeColorConstantColorLink_Material_SpecularValue__constantColor;
    float ComputeColorConstantFloatLink_Material_GlossinessValue__constantFloat;
    float2 ComputeColorTextureScaledOffsetDynamicSampler_Material_DiffuseMap_TEXCOORD0_Material_Sampler_i0_rgba_Material_TextureScale_Material_TextureOffset__scale;
    float2 ComputeColorTextureScaledOffsetDynamicSampler_Material_DiffuseMap_TEXCOORD0_Material_Sampler_i0_rgba_Material_TextureScale_Material_TextureOffset__offset;
};
cbuffer PerFrame
{
    float Global_Time;
...
SamplerState DynamicSampler_Material_Sampler_i0_PerMaterial__Sampler;
Texture2D<float4> DynamicTexture_Material_DiffuseMap_PerMaterial__Texture;
...
{
    return DynamicTexture_Material_DiffuseMap_PerMaterial__Texture.Sample(DynamicSampler_Material_Sampler_i0_PerMaterial__Sampler, (_streams.TexCoord_id34 * ComputeColorTextureScaledOffsetDynamicSampler_Material_DiffuseMap_TEXCOORD0_Material_Sampler_i0_rgba_Material_TextureScale_Material_TextureOffset__scale) + ComputeColorTextureScaledOffsetDynamicSampler_Material_DiffuseMap_TEXCOORD0_Material_Sampler_i0_rgba_Material_TextureScale_Material_TextureOffset__offset);
}
...
{
    return float4(ComputeColorConstantFloatLink_Material_GlossinessValue__constantFloat, ComputeColorConstantFloatLink_Material_GlossinessValue__constantFloat, ComputeColorConstantFloatLink_Material_GlossinessValue__constantFloat, ComputeColorConstantFloatLink_Material_GlossinessValue__constantFloat);
}
...
{
    return ComputeColorConstantColorLink_Material_SpecularValue__constantColor;
}
...
{
    return float4(ComputeColorConstantFloatLink_Material_SpecularIntensityValue__constantFloat, ComputeColorConstantFloatLink_Material_SpecularIntensityValue__constantFloat, ComputeColorConstantFloatLink_Material_SpecularIntensityValue__constantFloat, ComputeColorConstantFloatLink_Material_SpecularIntensityValue__constantFloat);
}
