...
{
    return (((PerDraw_var.ShaderComp_varDraw1 + PerDraw_var.o1S14C1_ShaderComp_varDraw3) + globalCbuffer_var.o1S14C1_ShaderComp_varG1) + globalCbuffer_var.ShaderComp_varG2) + PerToto_var.o1S14C1_ShaderComp_varCompToto;
}

float main()
{
    return (PerDraw_var.ShaderA_varDrawA + o1S14C1_ShaderComp_Compute()) + globalCbuffer_var.ShaderA_varG2;
}
