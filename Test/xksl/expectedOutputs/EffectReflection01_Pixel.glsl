...
void main()
{
    ...
    _streams.Depth_id2 = _streams.ShadingPosition_id0.w + globalCbuffer_var.ShaderMain_depthOffset;
    _streams.ColorTarget_id1 = vec4(_streams.ShadingPosition_id0.x, _streams.ShadingPosition_id0.y, 1.0, globalCbuffer_var.ShaderMain_depthOffset);
