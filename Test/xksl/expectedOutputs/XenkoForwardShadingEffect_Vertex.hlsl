...
static const VS_STREAMS _209 = { 0.0f.xxxx, 0.0f, 0.0f.xxx, 0.0f.xxxx, 0.0f.xxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f, 0.0f.xxxx, 0.0f.xx, 0.0f };
...
{
    float phase = length(_streams.TexCoord_id9 - 0.5f.xx);
...
{
    _streams.matDisplacement_id10 = o25S35C0_o23S2C0_o22S2C0_ComputeColorMultiply_Compute(_streams).x;
}
