...
cbuffer ReferenceCBuffer
{
    ...
    float4x4 ShaderMain__arrayA[3];
    float ShaderMain__varf;
    float3x4 ShaderMain__arrayB[4];
    float3x4 ShaderMain__af3x4;
    int4x4 ShaderMain__i4x4;
    int4x4 ShaderMain__i4x4A[2];
    float4x4 ShaderMain__arrayC[5];
    float4 ShaderMain__arrayD[2];
    float ShaderMain__BleedingFactor;
    uint ShaderMain__aB320;
    uint ShaderMain__aB321;
    float4x2 ShaderMain__arrayCC[1];
