...
layout(std140) uniform PerView
{
    ...
    vec4 o0S433C0_LightDirectionalGroup_padding_PerView_Default;
    ...
    vec4 o3S417C0_LightSimpleAmbient_padding_PerView_Lighting;
} PerView_var;
...
void o1S433C0_LightClustered_PrepareLightData(inout PS_STREAMS _streams)
{
    ...
    _streams.lightData_id58 = uvec2(texelFetch(SPIRV_Cross_CombinedLightClustered_LightClustersSPIRV_Cross_DummySampler, ivec4(ivec2(texCoord * PerView_var.o1S433C0_LightClustered_ClusterStride), slice, 0).xyz, ivec4(ivec2(texCoord * PerView_var.o1S433C0_LightClustered_ClusterStride), slice, 0).w).xy);
