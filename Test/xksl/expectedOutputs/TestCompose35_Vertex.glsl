...
{
    vec4 o1S2C0_o0S2C0_SphericalHarmonicsEnvironmentColor_padding_PerView_Default;
    vec3 o1S2C0_o0S2C0_SphericalHarmonicsEnvironmentColor_SphericalColors[9];
    vec4 o1S2C0_o0S2C0_SphericalHarmonicsEnvironmentColor_padding_PerView_Lighting;
} PerView_var;
