...
layout(std140) uniform PerLighting
{
    int ShaderMain_var7;
    int ShaderMain_var8;
    vec4 ShaderMain_padding_PerLighting_Default;
    int ShaderMain_var3;
    int ShaderMain_var4;
    vec4 ShaderMain_padding_PerLighting_subpart2;
    int ShaderMain_var1;
    int ShaderMain_var2;
    vec4 ShaderMain_padding_PerLighting_subpart1;
    int ShaderMain_var9;
    int ShaderMain_var10;
    int ShaderMain_var5;
    int ShaderMain_var6;
    vec4 ShaderMain_padding_PerLighting_subpart3;
} PerLighting_var;
