...
{
    return vec4(PerMaterial_var.o22S2C0_o21S2C0_o20S2C1_ComputeColorConstantFloatLink_Material_DisplacementValue__constantFloat, PerMaterial_var.o22S2C0_o21S2C0_o20S2C1_ComputeColorConstantFloatLink_Material_DisplacementValue__constantFloat, PerMaterial_var.o22S2C0_o21S2C0_o20S2C1_ComputeColorConstantFloatLink_Material_DisplacementValue__constantFloat, PerMaterial_var.o22S2C0_o21S2C0_o20S2C1_ComputeColorConstantFloatLink_Material_DisplacementValue__constantFloat);
}
...
void o24S2C0_o23S2C0_MaterialSurfaceDisplacement_Position_meshNormal_false__Compute(inout VS_STREAMS _streams)
{
    ...
    if (false)
    {
        scaledNormal *= PerDraw_var.o23S2C0_Transformation_WorldScale;
    }
