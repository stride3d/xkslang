...
vec4 o27S35C0_o25S2C0_o24S2C0_o22S2C0_ComputeColorWave_5_0_01__0_03__Compute(VS_STREAMS _streams)
{
...
vec4 o27S35C0_o25S2C0_o24S2C0_o23S2C1_ComputeColorConstantFloatLink_Material_DisplacementValue__Compute()
{
    return vec4(PerMaterial_var.o27S35C0_o25S2C0_o24S2C0_o23S2C1_ComputeColorConstantFloatLink_constantFloat, PerMaterial_var.o27S35C0_o25S2C0_o24S2C0_o23S2C1_ComputeColorConstantFloatLink_constantFloat, PerMaterial_var.o27S35C0_o25S2C0_o24S2C0_o23S2C1_ComputeColorConstantFloatLink_constantFloat, PerMaterial_var.o27S35C0_o25S2C0_o24S2C0_o23S2C1_ComputeColorConstantFloatLink_constantFloat);
}

vec4 o27S35C0_o25S2C0_o24S2C0_ComputeColorMultiply_Compute(VS_STREAMS _streams)
{
    vec4 tex1 = o27S35C0_o25S2C0_o24S2C0_o22S2C0_ComputeColorWave_5_0_01__0_03__Compute(_streams);
    vec4 tex2 = o27S35C0_o25S2C0_o24S2C0_o23S2C1_ComputeColorConstantFloatLink_Material_DisplacementValue__Compute();
    vec4 mix1 = tex1 * tex2;
    return mix1;
}
...
void SharedTextureCoordinate_VSMain(inout VS_STREAMS _streams)
{
...
void main()
{
    VS_STREAMS _streams = VS_STREAMS(vec4(0.0), 0.0, vec3(0.0), vec4(0.0), vec3(0.0), vec4(0.0), vec4(0.0), 0.0, vec4(0.0), vec2(0.0), vec4(0.0), 0.0);
    ...
    VS_OUT_ScreenPosition = _streams.ScreenPosition_id10;
}
