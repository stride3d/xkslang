...
layout(std140) uniform PerView
{
    ...
    LightDirectional_DirectionalLightData o0S297C0_LightDirectionalGroup_8__Lights[8];
...
{
    return texture(SPIRV_Cross_CombinedDynamicTexture_TextureDynamicSampler_Sampler, (_streams.TexCoord_id39 * PerMaterial_var.ComputeColorTextureScaledOffsetDynamicSampler_scale) + PerMaterial_var.ComputeColorTextureScaledOffsetDynamicSampler_offset);
}
...
{
    return PerMaterial_var.ComputeColorConstantColorLink_constantColor;
}
...
{
    _streams.lightColor_id29 = PerView_var.o0S297C0_LightDirectionalGroup_8__Lights[lightIndex].Color;
    _streams.lightDirectionWS_id28 = -PerView_var.o0S297C0_LightDirectionalGroup_8__Lights[lightIndex].DirectionWS;
}
