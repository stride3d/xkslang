...
{
    ShaderMain_Streams _54 = { _streams.matColor_id2, _streams.matBlend_id0, _streams.matNormal_id1, 0 };
    ShaderMain_Streams res = _54;
    return res;
}
...
void vert_main()
{
    VS_STREAMS _streams = { 0.0f, 0.0f.xxx, 0.0f.xxx };
