...
struct PS_STREAMS
{
    ...
    uvec2 lightData_id48;
    int lightIndex_id49;
    vec4 ScreenPosition_id50;
    vec2 TexCoord_id51;
};
...
{
    return texture(SPIRV_Cross_CombinedDynamicTexture_TextureDynamicSampler_Sampler, (_streams.TexCoord_id51 * PerMaterial_var.o21S267C0_o5S2C0_o4S2C0_ComputeColorTextureScaledOffsetDynamicSampler_scale) + PerMaterial_var.o21S267C0_o5S2C0_o4S2C0_ComputeColorTextureScaledOffsetDynamicSampler_offset);
}
...
{
    vec2 offset = _streams.TexCoord_id51 - vec2(0.5);
    ...
    vec2 _1264 = (((xz.yx * sign(offset.x)) * (-xy.x)) * 0.5) + vec2(0.5);
    vec3 normal;
    normal = vec3(_1264.x, _1264.y, normal.z);
    normal.z = xy.y;
...
{
    int realLightIndex = int(texelFetch(LightClustered_LightIndices, _streams.lightIndex_id49).x);
...
void o1S439C0_DirectLightGroup_PrepareDirectLight(inout PS_STREAMS _streams, int lightIndex)
{
    ...
    vec3 param_1 = _streams.PositionWS_id9.xyz;
    int param_2 = lightIndex;
    vec3 _298 = o1S439C0_ShadowGroup_ComputeShadow(_streams, param_1, param_2);
...
void o2S439C0_DirectLightGroup_PrepareDirectLight(inout PS_STREAMS _streams, int lightIndex)
{
    ...
    vec3 param_1 = _streams.PositionWS_id9.xyz;
    int param_2 = lightIndex;
    vec3 _573 = o2S439C0_ShadowGroup_ComputeShadow(_streams, param_1, param_2);
