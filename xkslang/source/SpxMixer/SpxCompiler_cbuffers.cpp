                ...
                if (cbufferData->isUsed)
                {
                    ...
                    for (int m = 0; m < countMembers; ++m)
                    {
                    ...
                    
                        {
                            ...
                            if (!GetTypeReflectionDescription(cbufferMemberType, isMatrixRowMajor, &(member.attribute), *typeReflectionData, &startPositionOfAllMemberDecorateInstructions, nullptr))
                            {
